...
class ImageSliderBlock(blocks.StructBlock):
    ...
    description = blocks.RichTextBlock(editor='default',required=False, help_text="Title for the image slider (Please add the '&lt;/br&gt;' tag where you want to break the line.)")    
