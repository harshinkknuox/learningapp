...
from .blocks import ImageSliderBlock,LinkBlock,HomePageSharesListBlock,HomePagesectionsecondBlock
...
class HomePage(Page):
    ...
    content = StreamField([
        ...
        ('subject_section', HomePagesectionsecondBlock(group="Card Blocks")),
