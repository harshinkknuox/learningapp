...
class HomeSubjectSectionBlock(blocks.StructBlock):
    heading = blocks.CharBlock(required=True, help_text=_("Add your heading"))
    sub_heading = blocks.CharBlock(required=False, help_text=_("Add sub heading"))
    subject_block = blocks.ListBlock(
        HomeSubjectSectionLink(),
        min_num=0,
        max_num=2,
        help_text=_("Add Subject information to this section"),
        label="Add Subject details"
    )

    class Meta:
        template = "home/blocks/subject_block.html"
        icon = "table"
        label = "Home Page Subject section Block"